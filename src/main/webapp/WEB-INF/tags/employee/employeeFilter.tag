...
<fmt:bundle basename="i18n.messages">
    <form id="filterForm">
        ...
        <div>
            ...
            <div class="center"><label for="identitycard"><fmt:message key="clients.message.identitycard"/></label></div>
            <input id="identitycard" name="identitycard" type="text" class="form-control edit-field filter-entity-field"/>

            <div class="center"><label for="workbook"><fmt:message key="clients.message.workbook"/></label></div>
            <input id="workbook" name="workbook" type="text" class="form-control edit-field filter-entity-field"/>

            <div class="center"><label for="rnn"><fmt:message key="clients.message.rnn"/></label></div>
            <input id="rnn" name="rnn" type="text" class="form-control edit-field filter-entity-field"/>

            <div class="center"><label for="sik"><fmt:message key="clients.message.sik"/></label></div>
            <input id="sik" name="sik" type="text" class="form-control edit-field filter-entity-field"/>
            ...
            <input id="virtual_balance" name="virtual_balance" type="text" class="form-control edit-field filter-entity-field"/>
