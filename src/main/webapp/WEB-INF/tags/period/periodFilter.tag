...
<fmt:bundle basename="i18n.messages">
    <form id="filterForm">
        ...
        <div>
            <div class="center"><label for="period"><fmt:message key="message.period"/></label></div>
            <input id="period" name="period" type="text" class="form-control edit-field filter-entity-field"/>
